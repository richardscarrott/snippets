...
// var owner = 'Tango';
// var repo = 'MobileWeb';
// var api = 'https://github.thetrainline.com/api/v3/';
// var path = '/src/client/snippets';
// var branch = 'master';
// var fullPath = path
//     ? `repos/${owner}/${repo}/contents/${path}`
//     : `repos/${owner}/${repo}/contents`;
//   // 'https://github.thetrainline.com/api/v3"'
//   new URL(`${fullPath}?ref=${branch}`, api);

// TODO: Improve this, it oddly enough depends on a trailing slash being on v3/...
